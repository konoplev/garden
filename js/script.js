...
$(":submit").click(function (e) {
    e.preventDefault();
    let searchResult = getSearchResult(...searchRequest.split(' '));
    $("#content-holder").empty();
    searchResult.forEach(r => $("#content-holder").append(getMatchResultTemplate(r.filename, r.title, r.text, r.date, r.tags)));
});
...
export function getMatchResultTemplate(filename, title, text, date, tags) {
    ...
    return template + "</span>\n" +
        ...
        "                            <a href='" + filename + ".html' class='more-link'>Continue reading <span class='meta-nav'>→</span></a>\n" +
        "                        </div>\n" +
        "                    </div>\n" +
        "                </article>"
}
